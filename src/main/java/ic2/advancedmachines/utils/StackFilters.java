...
public class StackFilters {
    ...
    public static final IStackFilter ELECTROLYZER_IN = new IStackFilter() {
        @Override
        public boolean match(ItemStack stack) {
            return stack != null && (AdvancedMachinesRecipes.electrolyzer_power.getOutputFor(stack, false) != null ||
                    AdvancedMachinesRecipes.electrolyzer_drain.getOutputFor(stack, false) != null);
        }
