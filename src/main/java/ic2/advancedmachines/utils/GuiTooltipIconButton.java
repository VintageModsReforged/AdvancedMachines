...
public class GuiTooltipIconButton extends GuiIconButton {
    ...
    private final GuiAdvancedElectricBlock gui;
    public boolean hovered;

    public GuiTooltipIconButton(GuiAdvancedElectricBlock gui, int id, int x, int y, int w, int h, ItemStack icon, boolean drawQuantity, Supplier<String> tooltip) {
