...
public class LangManager {
    ...
    public static final Logger LOGGER = Logger.getLogger("Vintage Core");
    ...
    private static <T extends ILangProvider> void addEntry(T provider, String modid, String lang) {
        ...
        try {
            LOGGER.info("Trying to load " + lang + ".lang file from /mods/" + modid + "/lang/ folder...");
            stream = provider.getClass().getResourceAsStream("/mods/" + modid + "/lang/" + lang + ".lang"); // use the default .lang file from modJar
            if (stream == null) {
                LOGGER.info("Trying to load " + lang + ".lang file from /config/" + modid + "/lang/ folder...");
            ...
            if (stream == null) {
                LOGGER.info("Couldn't load " + lang + ".lang file for " + modid + "...");
            }
            ...
            LOGGER.info("Couldn't load " + lang + ".lang file for" + modid + ". Skipping...");
        } finally {
            if (stream != null) {
                try {
                    stream.close();
