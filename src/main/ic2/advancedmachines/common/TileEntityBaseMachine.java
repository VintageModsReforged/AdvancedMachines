...
public abstract class TileEntityBaseMachine extends TileEntityMachine implements IEnergySink {
    ...
    public boolean isRedstonePowered() {
        return this.worldObj.isBlockIndirectlyGettingPowered(this.xCoord, this.yCoord, this.zCoord) || hasRedstoneUpgrade();
    }

    public boolean hasRedstoneUpgrade() {
        for (Integer index : this.upgradeSlots) {
            if (this.inventory[index] != null) {
                return this.inventory[index].getItem() == AdvancedMachines.redstoneUpgrade;
            }
        }
        return false;
    }
